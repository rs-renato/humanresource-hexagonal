...
@ComponentScan("br.com.hrs.persistence.repository.jpa")
@EnableJpaRepositories(basePackages ="br.com.hrs.persistence.repository.jpa", considerNestedRepositories = true, enableDefaultTransactions = false, transactionManagerRef = "jpaTransactionManager")
