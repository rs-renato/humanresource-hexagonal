...
//            employeeJdbcRepository.findById(null);
//        });
//
...
//    public void test02() {
//        Employee employee = employeeJdbcRepository.findById(-1);
...
//    public void test03() {
//
//        Employee employee = employeeJdbcRepository.findById(EMPLOYEE_ID);
//        logger.info(employee);
...
//
//        employee = employeeJdbcRepository.findById(EMPLOYEE_ID);
//
...
//        Employee employeeFound = employeeJdbcRepository.findById(employeeSaved.getId());
...
//    public void test07() {
//        boolean exists = employeeJdbcRepository.existsById(EMPLOYEE_ID);
...
//    public void test08() {
//        boolean exists = employeeJdbcRepository.existsById(-1);
...
//    public void test09() {
//        employeeJdbcRepository.deleteById(EMPLOYEE_ID);
//        Employee employee = employeeJdbcRepository.findById(EMPLOYEE_ID);
